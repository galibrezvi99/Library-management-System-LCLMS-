...
void addSampleBooks(void) {
    ...
    const char *books[NUM_CATEGORIES][BOOKS_PER_CATEGORY] = {
        // Academic books
        {"The Design of Everyday Things", "The Existential Pleasure of Engineering", "Engineering Mathematics", "Mathematics for Machine Learning",
         "The Pragmatic Programmer", "Refactoring", "Six Easy Pieces", "The Cartoon Guide to Physics", "Quantum Mechanics and Experience",
        ...
        {"Steve Jobs", "Into the Wild", "Team of Rivals: The Political Genius of Abraham Lincoln", "Alexander Hamilton",
         "Unbroken: A World War II Story of Survival, Resilience and Redemption", "Wild Swans: Three Daughters of China", "The Rise of Theodore Roosevelt",
         "Oscar Wilde", "Mornings on Horseback", "Means of Ascent", "Tolstoy", "Zelda", "The Lost Girls", "Grant",
         "A Beautiful Mind", "The Twelve Caesars", "A House in the Sky", "A. Lincoln", "Leo Africanus", "Muhammad: His Life Based on the Earliest Sources"},
        // Comic/Manga books
        ...
        // Politics books
        {"The Communist Manifesto", "1984", "Why We're Polarized", "Common Sense", "Between The World and Me", "The Wretched of the Earth",
         "The Republic", "The Prince", "Leviathan", "Second Treatise of Government", "The Social Contract", "Democracy in America", "On Liberty",
         "The Origins of Totalitarianism", "Why Nations Fail", "The Road to Serfdom", "The Populist's Guide to 2020", "Politics On the Edge",
         "This is Europe: The Way We Live Now", "Les Aveuglés: Comment Berlin et Paris ont laissé la voie libre à la Russie"},
        // Entertainment books
        {"Ender's Game", "The Da Vinci Code", "A Game of Thrones", "Ready Player One", "The Martian", "The Hitchhiker's Guide To The Galaxy",
    ...
    const char *authors[NUM_CATEGORIES][BOOKS_PER_CATEGORY] = {
        ...
        // Politics authors
        {"Karl Marx", "George Orwell", "Ezra Klein", "Thomas Paine", "Ta-Nehisi Coates", "Frantz Fanon", "Plato", "Niccolo Machiavelli",
         "Thomas Hobbes", "John Locke", "Jean-Jacques Rousseau", "Alexis de Tocqueville", "John Stuart Mill", "Hannah Arendt", "Daron Acemoglu",
